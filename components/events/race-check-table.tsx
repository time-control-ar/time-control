                        ...
                        >
                            <div className="w-full pt-3">
                                <div className="flex justify-between items-center gap-2 mb-2 px-6">
                                    ...
                                    {Boolean(selectedCategories.length > 0 || selectedModalities.length > 0) && (
                                        <button type="button" className="text-gray-500 dark:text-gray-400 text-sm font-medium tracking-tight" onClick={() => {
                                            ...
                                            Limpiar filtros {Boolean(selectedCategories.length > 0 || selectedModalities.length > 0) && `(${selectedCategories.length + selectedModalities.length})`}
                                        </button>
                                    )}
                                </div>
                                    ...
                                    <td className="!min-w-[150px] md:!max-w-max">
                                        <div className="flex flex-col items-start justify-center gap-2">
                                            ...
                                            <div className="flex gap-0.5">
                                                <div className="w-max">
                                                    <span className="inline-flex items-center px-2 py-0.5 rounded-xl text-xs font-medium border border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-200 tracking-tight">
