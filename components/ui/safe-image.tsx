...
export default function SafeImage({
    ...
    if (!validSrc || imageError) {
        return (
            <div className={`flex flex-col min-h-[300px] items-center justify-center w-full h-full ${className}`}>
    ...
    return (
        <motion.div className={`flex items-center justify-center w-full z-10 min-h-[300px] relative ${className}`}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
